  ...
  return (
    <div className="relative overflow-hidden  bg-gray-600">
      ...
      <Container className="relative py-8 text-center lg:py-12">
          ...
          <h1 className="font-display text-3xl font-medium tracking-tight text-white sm:text-4xl md:text-5xl lg:text-6xl">
            ...
            <div className="relative mt-2 block">
              ...
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
                className="-trannavy-x-1/2 absolute top-2/3 left-1/2 h-[0.4em] w-[60%] transform fill-mallorca-400"
        ...
        <p className="mx-auto mt-6 max-w-2xl text-sm tracking-tight text-navy-100 sm:text-base md:text-lg">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-sm tracking-tight text-navy-100 sm:text-base md:text-lg">
