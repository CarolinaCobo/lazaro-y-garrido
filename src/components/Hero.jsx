  ...
  return (
    <div className="relative overflow-hidden bg-black ">
      ...
      <Container className="relative pt-20 pb-16 text-center lg:pt-32">
          ...
          <h1 className="font-display text-3xl font-medium tracking-tight text-white sm:text-4xl lg:text-5xl">
            ...
            <div className="block mt-2 relative">
              ...
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
                className="absolute top-2/3 left-1/2 transform -translate-x-1/2 h-[0.4em] w-[60%] fill-mallorca-400"
        ...
        <p className="mx-auto mt-6 max-w-2xl text-sm tracking-tight text-slate-100 md:text-md">
